...
import { getPokemonAbility, getPokemonInfo, localFavorites } from "../../utils";
...
const PokemonInfo = ({ pokemon }) => {
  ...
  const [isInFavoritos, setIsInFavoritos] = useState(
      localFavorites.existInFavorites(pokemon.id));
  const onToggleFavoritos = () => {
        localFavorites.toggleFavoritos(pokemon.id)
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Grid.Container direction="row" justify={"center"} gap={2}>
                ...
                <Grid css={{ marginTop: "25px" }} xs={12} justify={"center"}>
                  <UIPagination
                    color={"gradient"}
                    shadow
